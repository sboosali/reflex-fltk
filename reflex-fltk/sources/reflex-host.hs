...
-- SCREEN_WIDTH_IN_PIXELS  = 3840
-- SCREEN_HEIGHT_IN_PIXELS = 2160

screenWidthInPixelsHighResolution  = 3840
screenHeightInPixelsHighResolution = 2160
...
makeDescription = do
  ...
  setTextsize description (FontSize 36)
